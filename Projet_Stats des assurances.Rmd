---
title: "Annexe de projet Stats des assurances"
author: "Isabelle Ajtay, Smail Chabane, Yuxuan ZHANG"
...
On a utilisé str pour afficher les informations simples des variables et summary pour afficher les données statistiques pour chaque variable. 
...
On peut constater que les variabilités des Sinistres des 3 types sont tout grandes.
...
```{r, echo=TRUE}
correlation=data %>% select_if(is.numeric) %>% cor()
